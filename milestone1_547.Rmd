...
Mean views, likes, dislikes and comment counts for video category
```{r}
...
Does the number of views of a Youtube video correlate with the number of comments it recieves?
